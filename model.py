...
class Model(torch.nn.Module):
    ...
    def forward_base(self, board_indexes, board_offsets):
        ...
        b_to_v, b_to_y, b_to_d, b_to_p = torch.split(board, [self.UNIT_SIZE, self.UNIT_SIZE, self.UNIT_SIZE, self.UNIT_SIZE], dim=1)
        ...
        return value, yaku, b_to_d, b_to_p

    def forward_discard(self, b_to_d):
    ...
    def forward_optional(self, action_indexes, action_offsets, b_to_p):
